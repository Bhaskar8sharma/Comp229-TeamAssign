                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                ...
                                <asp:RequiredFieldValidator ID="reqbookdescription" runat="server" ErrorMessage="Enter Book description." ControlToValidate="txtdescription" ForeColor="#FF6600"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                ...
                                <asp:RequiredFieldValidator ID="reqbookimg" runat="server" ErrorMessage="Select book Image." ControlToValidate="bookimg" ForeColor="#FF6600"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                ...
                                <asp:RequiredFieldValidator ID="reqbookwriter" runat="server" ErrorMessage="Enter Author." ControlToValidate="txtbookwriter" ForeColor="#FF6600"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                ...
                                <asp:RequiredFieldValidator ID="reqreleasedate" runat="server" ErrorMessage="Enter Release Date." ControlToValidate="txtreleasedate" ForeColor="#FF6600"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
